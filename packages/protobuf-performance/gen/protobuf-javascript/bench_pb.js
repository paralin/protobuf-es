...
goog.provide("proto.Outer");
goog.provide("proto.Test");
goog.provide("proto.Test.Enum");
goog.provide("proto.Test.Inner");
goog.provide("proto.Test.Inner.InnerInner");
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.Test.Inner.InnerInner.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        longfield: jspb.Message.getFieldWithDefault(msg, 1, 0),
...
/**
 * optional int64 longField = 1;
 * @return {number}
 */
proto.Test.Inner.InnerInner.prototype.getLongfield = function () {
 ...
 */
proto.Test.Inner.InnerInner.prototype.setLongfield = function (value) {
...
proto.Outer.prototype.getBoolList = function () {
  return /** @type {!Array<boolean>} */ (
    jspb.Message.getRepeatedBooleanField(this, 1)
  );
};
