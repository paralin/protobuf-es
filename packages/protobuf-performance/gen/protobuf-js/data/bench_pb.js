  ...
  Test.Inner = (function () {
    ...
    Inner.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "innerInner")
      )
        $root.Test.Inner.InnerInner.encode(
          message.innerInner,
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            break;
          case 2:
            message.innerInner = $root.Test.Inner.InnerInner.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    Inner.InnerInner = (function () {
      ...
      InnerInner.prototype.long = $util.Long
      ...
      InnerInner.encode = function encode(message, writer) {
        ...
        if (
          message["enum"] != null &&
          Object.hasOwnProperty.call(message, "enum")
        )
          writer.uint32(16).int32(message["enum"]);
        if (
          message.sint32 != null &&
          Object.hasOwnProperty.call(message, "sint32")
        )
...
$root.Outer = (function () {
  ...
  Outer.decode = function decode(reader, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          if (!(message.bool && message.bool.length)) message.bool = [];
          if ((tag & 7) === 2) {
            var end2 = reader.uint32() + reader.pos;
            while (reader.pos < end2) message.bool.push(reader.bool());
          } else message.bool.push(reader.bool());
          break;
        case 2:
